...
export class TransactionRoutes implements BaseRouter {
  public loadRoutes(app: Application): void {
    ...
    app.post('/transactions', auth, makeRoute(new AddTransactionController(new AddTransactionValidator(new UserRepository()), new TransactionRepository())));
    app.put('/transactions/:transactionId', auth, makeRoute(new UpdateTransactionController(new UpdateTransactionValidator(new UserRepository(), new TransactionRepository()), new TransactionRepository())));
  }
}
